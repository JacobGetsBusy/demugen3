import { createLobby, joinLobby, setReady, leaveLobby, startGame, } from '../lobby/lobby-manager.js';
...
export function setupGateway(io, state) {
...
function broadcastGameState(io, gameState, lobby) {
