...
import {
  ...
  leaveLobby,
  startGame,
} from '../../src/lobby/lobby-manager.js';
...
describe('LobbyManager', () => {
  ...
  describe('joinLobby', () => {
    ...
    it('game already started — returns error', () => {
      ...
      const startedLobby: Lobby = { ...lobby, gameStarted: true };
  ...
  describe('setReady', () => {
    ...
    it('all players ready — lobby allReady flag true', () => {
      ...
      const allReady = lobby.players.every((p: { isReady: boolean }) => p.isReady);
