...
import type { UnitInstance, UnitCard } from '@mugen/shared';

const mockUnitCard: UnitCard = {
  id: 'unit-1',
  name: 'Fire Warrior',
...
const mockUnitInstance: UnitInstance = {
  card: mockUnitCard,
  currentHp: 10,
  position: { x: 3, y: 4 },
  ownerId: 'p1',
